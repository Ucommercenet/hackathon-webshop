app.config(function ($routeProvider) {
    $routeProvider
        ...
        .when('/Vue/index.html#dashboard', {
            redirectTo: function () {
                return buildUrl(`Vue/index.html?unique=${getRandom()}#dashboard`);
            }
        })
		.when('/Vue/index.html#stores', {
			redirectTo: function () {
				return buildUrl(`Vue/index.html?unique=${getRandom()}#stores`);
			}
		})
		//
		// Catalog
        ...
        .when('/Vue/index.html#catalogs', {
            redirectTo: function () {
                return buildUrl(`Vue/index.html?unique=${getRandom()}#catalogs`);
            }
        })
        .when('/Vue/index.html#products', {
            redirectTo: function () {
                return buildUrl(`Vue/index.html?unique=${getRandom()}#products`);
            }
        })
